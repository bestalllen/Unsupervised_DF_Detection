...
def process_faces(face_crop_list, landmarks_list, scale=256):
    ...
    # # # ## F2F
    # features_2 = extract_features_nose(landmarks, face_crop, scale=scale)
    features_3 = extract_features_faceborder(landmarks, face_crop, scale=scale)
    ## NT
    # features_1 = extract_features_mouth(landmarks, face_crop, scale=scale)
    ...
    # if features_0 is not None and features_1 is not None and features_2 is not None:
    #     # combine to single feature vector
    #     feature_vector = np.concatenate((features_0, features_1, features_2))
    # if features_0 is not None:
    #     # combine to single feature vector
    #     feature_vector = features_0    
